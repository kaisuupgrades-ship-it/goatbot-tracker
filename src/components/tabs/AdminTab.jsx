            ...
            {picks.map((p, i) => {
              ...
              return (
                <tr key={p.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.04)', background: adminEdited ? 'rgba(255,184,0,0.03)' : i % 2 === 0 ? 'transparent' : 'rgba(255,255,255,0.01)' }}>
                  ...
                  <td style={{ padding: '0.5rem 0.75rem', color: 'var(--text-primary)', fontWeight: 700, maxWidth: '180px' }}>
                    <div style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{p.team}</div>
                    {(p.matchup || (p.home_team && p.away_team)) && (
                      <div style={{ fontSize: '0.62rem', color: 'var(--text-muted)', fontWeight: 400, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
